...
exchange_calendars supplies XFRA sessions, holidays supplies the ECB
TARGET closing days, and a continuous date spine turns both into a gapless
table. Reproducibility contract: same library versions + same spans -> same parquet.
Lineage names the versions, since there is no source file to name.
...
def xfra_days() -> dict[str, bool]:
    """XFRA trading days over the library's span."""
